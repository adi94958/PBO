...
public class WeeklySales {
    public static void main(String[] args) {
        ...
        salesStaff[1] = new Salesperson("Daffy", "Duck", 3939);
        ...
        salesStaff[6] = new Salesperson("Harry", "Tylor", 7300);
        salesStaff[7] = new Salesperson("Andy", "Adams", 5000);
        salesStaff[8] = new Salesperson("Jim", "Doe", 2500);
        salesStaff[9] = new Salesperson("Walt", "Smith", 3000);

        Sorting.insertionSort(salesStaff);
        System.out.println("\nRanking for Sales for the Week\n");
